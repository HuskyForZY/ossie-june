...
#define __standardInterfaces_maudioInControl__
  ...
  public:
    ...
    enum InType { itMicrophone, itNet, itFile /*, __max_InType=0xffffffff */ };
    typedef InType& InType_out;

    static _dyn_attr const ::CORBA::TypeCode_ptr _tc_InType;
...
#define __standardInterfaces_maudioOutControl__
  ...
  public:
    ...
    // Other IDL defined within this scope.
    enum OutType { otSpeaker, otNet, otFile /*, __max_OutType=0xffffffff */ };
    typedef OutType& OutType_out;

    static _dyn_attr const ::CORBA::TypeCode_ptr _tc_OutType;
...
inline void operator >>=(standardInterfaces::audioInControl::InType _e, cdrStream& s) {
...
inline void operator <<= (standardInterfaces::audioInControl::InType& _e, cdrStream& s) {
  ::CORBA::ULong _0RL_e;
  ::operator<<=(_0RL_e,s);
  if (_0RL_e <= standardInterfaces::audioInControl::itFile) {
    _e = (standardInterfaces::audioInControl::InType) _0RL_e;
  }
  else {
...
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, standardInterfaces::audioInControl::InType& _s);
...
inline void operator >>=(standardInterfaces::audioOutControl::OutType _e, cdrStream& s) {
  ::operator>>=((::CORBA::ULong)_e, s);
}
...
inline void operator <<= (standardInterfaces::audioOutControl::OutType& _e, cdrStream& s) {
  ::CORBA::ULong _0RL_e;
  ::operator<<=(_0RL_e,s);
  if (_0RL_e <= standardInterfaces::audioOutControl::otFile) {
    _e = (standardInterfaces::audioOutControl::OutType) _0RL_e;
  }
  else {
    OMNIORB_THROW(MARSHAL,_OMNI_NS(MARSHAL_InvalidEnumValue),
                  (::CORBA::CompletionStatus)s.completion());
...
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, standardInterfaces::audioOutControl::OutType& _s);
