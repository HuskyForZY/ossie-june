...
#define __CF_mAggregateDevice__
  ...
  {
  public:
    void addDevice(Device_ptr associatedDevice);
    void removeDevice(Device_ptr associatedDevice);
  ...
  public:
    ...
    virtual void addDevice(Device_ptr associatedDevice) = 0;
    virtual void removeDevice(Device_ptr associatedDevice) = 0;
...
#define __CF_mFileSystem__
  ...
  public:
    ...
    void query(Properties& fileSystemProperties);
  ...
  public:
    ...
    virtual void query(Properties& fileSystemProperties) = 0;
...
#define __CF_mFile__
  ...
  {
  public:
    void read(OctetSequence_out data, ::CORBA::ULong length);
    void write(const OctetSequence& data);
    ::CORBA::ULong sizeOf();
    void close();
  ...
  public:
    ...
    virtual void read(OctetSequence_out data, ::CORBA::ULong length) = 0;
    virtual void write(const OctetSequence& data) = 0;
...
#define __CF_mResourceFactory__
  ...
  {
  public:
    Resource_ptr createResource(const char* resourceId, const Properties& qualifiers);
  ...
  public:
    ...
    virtual Resource_ptr createResource(const char* resourceId, const Properties& qualifiers) = 0;
...
#define __CF_mFileManager__
  ...
  {
  public:
    void mount(const char* mountPoint, FileSystem_ptr file_System);
  ...
  public:
    ...
    virtual void mount(const char* mountPoint, FileSystem_ptr file_System) = 0;
...
#define __CF_mTestableObject__
  ...
  {
  public:
    void runTest(::CORBA::ULong testid, Properties& testValues);
  ...
  public:
    ...
    virtual void runTest(::CORBA::ULong testid, Properties& testValues) = 0;
...
#define __CF_mPropertySet__
  ...
  {
  public:
    void configure(const Properties& configProperties);
    void query(Properties& configProperties);
  ...
  public:
    ...
    virtual void configure(const Properties& configProperties) = 0;
    virtual void query(Properties& configProperties) = 0;
...
#define __CF_mDomainManager__
  ...
  {
  public:
    void registerDevice(Device_ptr registeringDevice, DeviceManager_ptr registeredDeviceMgr);
    void registerDeviceManager(DeviceManager_ptr deviceMgr);
    void unregisterDeviceManager(DeviceManager_ptr deviceMgr);
    void unregisterDevice(Device_ptr unregisteringDevice);
    void installApplication(const char* profileFileName);
    void uninstallApplication(const char* applicationId);
    void registerService(::CORBA::Object_ptr registeringService, DeviceManager_ptr registeredDeviceMgr, const char* name);
  ...
  public:
    ...
    virtual void registerDevice(Device_ptr registeringDevice, DeviceManager_ptr registeredDeviceMgr) = 0;
    virtual void registerDeviceManager(DeviceManager_ptr deviceMgr) = 0;
    virtual void unregisterDeviceManager(DeviceManager_ptr deviceMgr) = 0;
    virtual void unregisterDevice(Device_ptr unregisteringDevice) = 0;
    virtual void installApplication(const char* profileFileName) = 0;
    virtual void uninstallApplication(const char* applicationId) = 0;
    virtual void registerService(::CORBA::Object_ptr registeringService, DeviceManager_ptr registeredDeviceMgr, const char* name) = 0;
...
#define __CF_mApplicationFactory__
  ...
  {
  public:
    Application_ptr create(const char* name, const Properties& initConfiguration, const DeviceAssignmentSequence& deviceAssignments);
    char* name();
    char* identifier();
  ...
  public:
    ...
    virtual Application_ptr create(const char* name, const Properties& initConfiguration, const DeviceAssignmentSequence& deviceAssignments) = 0;
    virtual char* name() = 0;
    virtual char* identifier() = 0;
...
#define __CF_mDevice__
  ...
  {
  public:
    ::CORBA::Boolean allocateCapacity(const Properties& capacities);
    void deallocateCapacity(const Properties& capacities);
    Device::UsageType usageState();
    Device::AdminType adminState();
    void adminState(Device::AdminType _v);
  ...
  public:
    ...
    virtual ::CORBA::Boolean allocateCapacity(const Properties& capacities) = 0;
    virtual void deallocateCapacity(const Properties& capacities) = 0;
    virtual Device::UsageType usageState() = 0;
    virtual Device::AdminType adminState() = 0;
    virtual void adminState(Device::AdminType _v) = 0;
...
#define __CF_mLoadableDevice__
  ...
  {
  public:
    void load(FileSystem_ptr fs, const char* fileName, LoadableDevice::LoadType loadKind);
  ...
  public:
    ...
    virtual void load(FileSystem_ptr fs, const char* fileName, LoadableDevice::LoadType loadKind) = 0;
...
#define __CF_mExecutableDevice__
  ...
  {
  public:
    void terminate(ExecutableDevice::ProcessID_Type processId);
    ExecutableDevice::ProcessID_Type execute(const char* name, const Properties& options, const Properties& parameters);
  ...
  public:
    ...
    virtual void terminate(ExecutableDevice::ProcessID_Type processId) = 0;
    virtual ExecutableDevice::ProcessID_Type execute(const char* name, const Properties& options, const Properties& parameters) = 0;
...
#define __CF_mDeviceManager__
  ...
  {
  public:
    void registerDevice(Device_ptr registeringDevice);
    void unregisterDevice(Device_ptr registeredDevice);
    void shutdown();
  ...
  public:
    ...
    virtual void registerDevice(Device_ptr registeringDevice) = 0;
    virtual void unregisterDevice(Device_ptr registeredDevice) = 0;
    virtual void shutdown() = 0;
