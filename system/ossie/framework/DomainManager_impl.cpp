...
// Mount the file system to the file manager
    try {
        ...
        std::cout << "[DomainManager::ctor] While mounting File System: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } /*catch( CF::InvalidFileSystem &_ex ) {
     std::cout << "[DomainManager::ctor] While mounting File System: Invalid File System\n";
     exit(EXIT_FAILURE);
    } catch( CF::MointPointAlreadyExists &_ex ) {
     std::cout << "[DomainManager::ctor] While mounting File System: Moint point already exists\n";
     exit(EXIT_FAILURE);
    }*/ catch ( ... ) {
        exit(EXIT_FAILURE);
    }
// Parse the DMD profile
    ...
    try {
        ...
        std::cout << "[DomainManager::ctor] While opening DMD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    ...
    try {
        ...
        std::cout << "[DomainManager::ctor] \"dmd->close\" failed with CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::ctor] \"dmd->close\" failed with Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
/// \todo Discuss using filename + path directly from xml and screwing with FileSystem
    ...
    try {
        ...
        std::cout << "[DomainManager::ctor] While obtaining File Information Sequence: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( CF::FileException &_ex ) {
        std::cout << "[DomainManager::ctor] While obtaining File Information Sequence: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    ...
    try {
        ...
        std::cout << "[DomainManager::ctor] While opening SPD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( CF::FileException &_ex ) {
        std::cout << "[DomainManager::ctor] While opening SPD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    ...
    try {
        ...
        std::cout << "[DomainManager::ctor] \"spd->close\" failed with CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::ctor] \"spd->close\" failed with Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
//      add device manager to list
    ...
    try {
        ...
        std::cout << "[DomainManager::registerDeviceManager] While calling \"identifier\": CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::registerDeviceManager] While calling \"identifier\": Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
    ...
    try {
        ...
        std::cout << "[DomainManager::registerDeviceManager] While calling \"label\": CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::registerDeviceManager] While calling \"label\": Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
//      mount filesystem under "/DomainName1/<deviceMgr.label>"
    ...
    try {
        ...
        std::cout << "[DomainManager::registerDeviceManager] While mounting DevMgr FileSys: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::registerDeviceManager] While mounting DevMgr FileSys: Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
DomainManager_impl::addDeviceMgrDevices (CF::DeviceManager_ptr deviceMgr)
{
    ...
    try {
        ...
        std::cout << "[DomainManager::addDeviceMgrDevices] While calling \"registeredDevices\": CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::addDeviceMgrDevices] While calling \"registerDevices\": Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
//mountPoint += "/";
    ...
    try {
        ...
        std::cout << "[DomainManager::unregisterDeviceManager] While calling \"label\": CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::unregisterDeviceManager] While calling \"label\": Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
    ...
    try {
        ...
        std::cout << "[DomainManager::unregisterDeviceManager] \"fileMgr->unmount\" failed with CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::unregisterDeviceManager] \"fileMgr->unmount\" failed with Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
//the DeviceManager that is being unregistered.
    ...
    try {
        ...
        std::cout << "[DomainManager::removeDeviceMgrDevices] \"deviceMgr->registeredDevices\" failed with CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::removeDeviceMgrDevices] \"deviceMgr->registeredDevices\" failed with Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
//Call unregisterDevice for each device in the DeviceMgr
    for (unsigned int i = 0; i < devices->length (); i++) {
        ...
        try {
            ...
            std::cout << "[DomainManager::removeDeviceMgrDevices] \"unregisterDevice\" failed with CF::InvalidObjectReference\n";
            exit(EXIT_FAILURE);
        }
        CORBA::release(_dev);
    }
...
//Check the DCD for connections and establish them
    ...
    try {
        ...
        std::cout << "[DomainManager::registerDevice] While calling \"identifier\": CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::registerDevice] While calling \"identifier\": Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
    ...
    try {
        ...
        std::cout << "[DomainManager::registerDevice] While calling \"label\": CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::registerDevice] While calling \"label\": Unknwon Exception\n";
        exit(EXIT_FAILURE);
    }
...
bool DomainManager_impl::deviceIsRegistered ( const CF::Device_ptr registeredDevice)
{
    ...
    for (unsigned int i = 0; i < _registeredDevices.size (); i++) {
        ...
        try {
            ...
            std::cout << "[DomainManager::deviceIsRegistered] \"registeredDevice->label\" failed with Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
...
//when the service registers with the DomainManager by the registerDeviceManager operation.
    ...
    try {
        ...
        std::cout << "[DomainManager::establishServiceConnections] While calling \"deviceConfigurationProfile\": CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::establishServiceConnections] While calling \"deviceConfigurationProfile\": Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
//get DCD's connections
    ...
    try {
        ...
        std::cout << "[DomainManager::establishServiceConnections] While opening Dev Config profile: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( CF::FileException &_ex ) {
        std::cout << "[DomainManager::establishServiceConnections] While opening Dev Config profile: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::establishServiceConnections] While opening Dev Config profile: Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
    ...
    try {
        ...
        std::cout << "[DomainManager::establishServiceConnections] \"dcd->close\" failed with CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::establishServiceConnections] \"dcd->close\" failed with Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
//search registered devices to obtain the deviceManager of this service
    ...
    try {
        ...
        std::cout << "[DomainManager::disconnectThisService] While calling \"deviceConfigurationProfile\": Caught CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::disconnectThisService] While calling \"deviceConfigurationProfile\": Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
//get the DCD
    ...
    try {
        ...
        std::cout << "[DomainManager::disconnectThisService] While opening DCD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( CF::FileException &_ex ) {
        std::cout << "[DomainManager::disconnectThisService] While opening DCD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::disconnectThisService] While opening DCD: Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
    ...
    try {
        ...
        std::cout << "[DomainManager::disconnectThisService] \"dcd->close\" failed with CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::disconnectThisService] \"dcd->close\" failed with Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
//               then the DomainManager throws a CF::InvalidProfile if the SAD does not conform
        ...
        try {
            ...
            std::cout << "[DomainManager::installApplication] While opening SAD file: " << _ex.msg << "\n";
            exit(EXIT_FAILURE);
        } catch ( CF::FileException &_ex ) {
            std::cout << "[DomainManager::installApplication] While opening SAD file: " << _ex.msg << "\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DomainManager::installApplication] While opening SAD file: Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
        ...
        try {
            ...
            std::cout << "[DomainManager::installApplication] \"sad->close\" failed with CORBA::SystemException\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DomainManager::installApplication] \"sad->close\" failed with Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
...
// check if application factory already exists for this profile
        for (unsigned int i = 0; i < appFact_servants.size(); i++) {
            ...
            try {
                ...
                std::cout << "[DomainManager::installApplication] While calling \"identifier[" << i << "]\": CORBA::SystemException\n";
                exit(EXIT_FAILURE);
            } catch ( ... ) {
                std::cout << "[DomainManager::installApplication] While calling \"identifier[" << i << "]\": Unknown Exception\n";
                exit(EXIT_FAILURE);
            }
...
///\bug Figure out MSVC flags to corectly scope for loops
    for (unsigned int i = 0; i < appFact_servants.size(); i++) {
        ...
        try {
            ...
            std::cout << "[DomainManager::uninstallApplication] While calling \"identifier[" << i << "]\": CORBA::SystemException\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DomainManager::uninstallApplication] While calling \"identifier[" << i << "]\": Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
    ...
    try {
        ...
        std::cout << "[DomainManager::uninstallApplication] While calling \"softwareProfile[" << appNum << "]\": CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::uninstallApplication] While calling \"softwareProfile[" << appNum << "]\": Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
    ...
    try {
        ...
        std::cout << "[DomainManager::uninstallApplication] While opening SAD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( CF::FileException &_ex ) {
        std::cout << "[DomainManager::uninstallApplication] While opening SAD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::uninstallApplication] While opening SAD: Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
// NOTE: there is a problem in the destructor of the SADParser
    ...
    try {
        ...
        std::cout << "[DomainManager::uninstallApplication] \"sad->close\" failed with CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::uninstallApplication] \"sad->close\" failed with Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
/// \todo Figure out checks for xml conforming to dtd, through suitable exception if it doesn't. Possibly CF::InvalidProfile
    ...
    try {
        ...
        try {
            ...
            std::cout << "[DomainManager::validateSPD] While opening SPD: " << _ex.msg << "\n";
            exit(EXIT_FAILURE);
        } catch ( CF::FileException &_ex ) {
            std::cout << "[DomainManager::validateSPD] While opening SPD: " << _ex.msg << "\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DomainManager::validateSPD] While opening SPD: Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
        ...
        try {
            ...
            std::cout << "[DomainManager::validateSPD] \"spd->close\" failed with CORBA::SystemException\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DomainManager::validateSPD] \"spd->close\" failed with Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
        ...
        try {
            ...
            std::cout << "[DomainManager::validateSPD] While opening PRF: " << _ex.msg << "\n";
            exit(EXIT_FAILURE);
        } catch ( CF::FileException &_ex ) {
            std::cout << "[DomainManager::validateSPD] While opening PRF: " << _ex.msg << "\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DomainManager::validateSPD] While opening PRF: Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
        ...
        try {
            ...
            std::cout << "[DomainManager::validateSPD] \"prf->close\" failed with CORBA::SystemException\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DomainManager::validateSPD] \"prf->close\" failed with Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
        ...
        try {
            ...
            std::cout << "[DomainManager::validateSPD] While opening SCD: " << _ex.msg << "\n";
            exit(EXIT_FAILURE);
        } catch ( CF::FileException &_ex ) {
            std::cout << "[DomainManager::validateSPD] While opening SCD: " << _ex.msg << "\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DomainManager::validateSPD] While opening SCD: Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
        ...
        try {
            ...
            std::cout << "[DomainManager::validateSPD] \"scd->close\" failed with CORBA::SystemException\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DomainManager::validateSPD] \"scd->close\" failed with Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
...
DomainManager_impl::removeSPD (const char *_spdProfile, int _cnt)
{
    ...
    try {
        ...
        std::cout << "[DomainManager::removeSPD] While opening SPD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( CF::FileException &_ex ) {
        std::cout << "[DomainManager::removeSPD] While opening SPD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::removeSPD] While opening SPD: Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
    ...
    try {
        ...
        std::cout << "[DomainManager::removeSPD] \"spd->close\" failed with CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DomainManager::removeSPD] \"spd->close\" failed with Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
