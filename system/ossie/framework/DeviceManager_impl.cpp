...

{
    ...
    try {
        ...
        std::cout << "[DeviceManager::post_ctor] While testing for the existence of DCD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DeciceManager::post_ctor] While testing for the existence of DCD: Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
//from DCD file
    ...
    try {
        ...
        std::cout << "[DeviceManager::post_ctor] While opening DCD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( CF::FileException &_ex ) {
        std::cout << "[DeviceManager::post_ctor] While opening DCD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DeviceManager::post_ctor] While opening DCD: Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
    ...
    try {
        ...
        std::cout << "[DeviceManager::post_constructor] \"dcd->close\" failed with CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DeviceManager::post_constructor] \"dcd->close\" failed with Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
    ...
    try {
        ...
        std::cout << "[DeviceManager::post_ctor] While opening DeviceManager SPD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( CF::FileException &_ex ) {
        std::cout << "[DeviceManager::post_ctor] While opening DeviceManager SPD: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DeviceManager::post_ctor] While opening DeviceManager SPD: Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
    ...
    try {
        ...
        std::cout << "[DeviceManager::post_constructor] \"devmgrspd->close\" failed with CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DeviceManager::post_constructor] \"devmgrspd->close\" failed with Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
//Register DeviceManager with DomainManager
    ...
    try {
        ...
        std::cout << "[DeviceManager::post_ctor] While registering DevMgr with DomMgr: " << _ex.msg << "\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DeviceManager::post_ctor] While registering DevMgr with DomMgr: Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
...
//Parse local componenents from DCD files
    ...
    for (unsigned int i = 0; i < componentPlacements.size(); i++) {
        ...
        try {
            ...
            std::cout << "[DeviceManager::post_ctor] While opening SPD " << i << ": " << _ex.msg << "\n";
            exit(EXIT_FAILURE);
        } catch ( CF::FileException &_ex ) {
            std::cout << "[DeviceManager::post_ctor] While opening SPD " << i << ": " << _ex.msg << "\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DeviceManager::post_ctor] While opening SPD " << i << ": Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
        ...
        try {
            ...
            std::cout << "[DeviceManager::post_constructor] \"spd->close\" failed with CORBA::SystemException\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DeviceManager::post_constructor] \"spd->close\" failed with Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
        ...
        do {
            ...
            try {
                ...
                std::cout << "[DeviceManager::post_ctor] While obtaining NamingContext: Unknown Exception\n";
                exit(EXIT_FAILURE);
            }
        ...
        try {
            ...
            std::cout << "[DeviceManager::post_constructor] \"tempDevice->initialize\" failed with CORBA::SystemException\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DeviceManager::post_constructor] \"tempDevice->initialize\" failed with Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
        ...
        for (int k = 0; k < PRFPaths.size(); k++) {
            ...
            try {
                ...
                std::cout << "[DeviceManager::post_ctor] While opening PRF " << PRFPaths[k] <<  ": " << _ex.msg << "\n";
                exit(EXIT_FAILURE);
            } catch ( CF::FileException &_ex ) {
                std::cout << "[DeviceManager::post_ctor] While opening PRF " << PRFPaths[k] << ": " << _ex.msg << "\n";
                exit(EXIT_FAILURE);
            } catch ( ... ) {
                std::cout << "[DeviceManager::post_ctor] While opening PRF: Unknown Exception\n";
                exit(EXIT_FAILURE);
            }
            ...
            try {
                ...
                std::cout << "[DeviceManager::post_constructor] \"prf->close\" failed with CORBA::SystemException\n";
                exit(EXIT_FAILURE);
            } catch ( ... ) {
                std::cout << "[DeviceManager::post_constructor] \"prf->close\" failed with Unknown Exception\n";
                exit(EXIT_FAILURE);
            }
        ...
        try {
            ...
            std::cout << "[DeviceManager::post_constructor] \"tempDevice->configure\" failed with CORBA::SystemException\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DeviceManager::post_constructor] \"tempDevice->configure\" failed with Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
        ...
        try {
            ...
            std::cout << "[DeviceManager::post_ctor] While registering Device: " << _ex.msg << "\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DeviceManager::post_ctor] While registering Device: Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
...
// parse all DPD files
    ...
    for (int k = 0; k < DPDList.size(); k++) {
        try {
            ...
            std::cout << "While Opening DPD (" << DPDList[k] << "): " << _ex.msg  << "\n";
            exit(EXIT_FAILURE);
        } catch (CF::FileException &_ex) {
            std::cout << "While Opening DPD (" << DPDList[k] << "): " << _ex.msg << "\n";
            exit(EXIT_FAILURE);
        } catch (...) {
            std::cout << "While Opening DPD: Unknown Exception\n";
        }
        ...
        try {
            ...
            std::cout << "[DeviceManager::parseDPDFiles] \"dpdfile->close\" failed with CORBA::SystemException\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DeviceManager::parseDPDFiles] \"dpdfile->close\" failed with Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
    }
...
/// \todo sleep prevents system from beating Name Service to death, Fix better
    do {
        try {
            ...
            std::cout << "[DeviceManager::getDomainManagerReference] \"get_object_from_name\" failed with CORBA::SystemException\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DeviceManager::getDomainManagerReference] \"get_object_from_name\" failed with Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
        usleep(1000);
    ...
    try {
        ...
        std::cout << "[DeviceManager::getDomainManagerReference] \"CF:DomainManager::_narrow\" failed with Unknown Exception\n";
    }
}
...
// the new device with the Domain Manager
    if (_adminState == DEVMGR_REGISTERED) {
        try {
            ...
            std::cout << "[DeviceManager::registerDevice] \"dmnMgr->registerDevice\" failed with CORBA::SystemException\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DeviceManager::registerDevice] \"dmnMgr->registerDevice\" failed with Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
    }
...
//when the appropiater device is found, remove it from the _registeredDevices sequence
            ...
            if (_adminState == DEVMGR_REGISTERED) {
                try {
                    ...
                    std::cout << "[DeviceManager::unregisterDevice] \"dmnMgr->unregisterDevice\" failed with CORBA::SystemException\n";
                    exit(EXIT_FAILURE);
                } catch ( ... ) {
                    std::cout << "[DeviceManager::unregisterDevice] \"dmnMgr->unregisterDevice\" failed with Unknown Exception\n";
                    exit(EXIT_FAILURE);
                }
...
//The shutdown operation shall unregister the DeviceManager from the DomainManager.
    try {
        ...
        std::cout << "[DeviceManager::shutdown] \"dmnMgr->unregisterDeviceManager\" failed with CF::InvalidObjectReference\n";
        exit(EXIT_FAILURE);
    } catch ( CORBA::SystemException& se ) {
        std::cout << "[DeviceManager::shutdown] \"dmnMgr->unregisterDeviceManager\" failed with CORBA::SystemException\n";
        exit(EXIT_FAILURE);
    } catch ( ... ) {
        std::cout << "[DeviceManager::shutdown] \"dmnMgr->unregisterDeviceManager\" failed with Unknown Exception\n";
        exit(EXIT_FAILURE);
    }
}
...
//attribute.
    if (_adminState == DEVMGR_REGISTERED) {
        try {
            ...
            std::cout << "[DeviceManager::registerService] \"dmnMgr->registerService\" failed with CORBA::SystemException\n";
            exit(EXIT_FAILURE);
        } catch ( ... ) {
            std::cout << "[DeviceManager::registerService] \"dmnMgr->registerService\" failed with Unknown Exception\n";
            exit(EXIT_FAILURE);
        }
    }
...
//when the appropiater device is found, remove it from the _registeredDevices sequence
            if (_adminState == DEVMGR_REGISTERED) {
                try {
                    ...
                    std::cout << "[DeviceManager::unregisterService] \"dmnMgr->unregisterService\" failed with CORBA::SystemException\n";
                    exit(EXIT_FAILURE);
                } catch ( ... ) {
                    std::cout << "[DeviceManager::unregisterService] \"dmnMgr->unregisterService\" failed with Unknown Exception\n";
                    exit(EXIT_FAILURE);
                }
            }
