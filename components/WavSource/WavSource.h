...
#ifndef WAVSOURCE_IMPL_H
#define WAVSOURCE_IMPL_H
 ...
 *
 */
class WavSource_i : public virtual Resource_impl
{
  public:
    /// Initializing constructor
    WavSource_i(const char *uuid, omni_condition *sem);
