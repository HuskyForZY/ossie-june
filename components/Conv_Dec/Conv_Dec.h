...
#ifndef CONV_DEC_IMPL_H
#define CONV_DEC_IMPL_H
 ...
 *
 */
class Conv_Dec_i : public virtual Resource_impl
{
public:
/// Initializing constructor
    Conv_Dec_i(const char *uuid, omni_condition *sem);
